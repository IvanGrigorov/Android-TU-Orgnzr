...
import com.androidprojects.tudevs.tu_orgnzr.databinding.FragmentThursdayProgramBinding;
 ...
 */
public class ThursdayFragment extends CustomWeekDayFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FragmentThursdayProgramBinding thursday = DataBindingUtil.inflate(inflater, R.layout.fragment_thursday_program, container, false);
        TextView day_of_week_textview = thursday.DayOfWeek;
        Button editButton = thursday.ImportedTable.EditButton;
        ...
        TableLayout tableContainer = thursday.ImportedTable.ProgrammTable;
